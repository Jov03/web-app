...
import { SingleRowDatatableStepComponent } from './client-form-steps/client-form-datatable-step/single-row-datatable-step/single-row-datatable-step.component';
import { MultiRowDatatableStepComponent } from './client-form-steps/client-form-datatable-step/multi-row-datatable-step/multi-row-datatable-step.component';
import { ClientFormPreviewStepComponent } from './client-form-steps/client-form-preview-step/client-form-preview-step.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ClientFormPreviewStepComponent
  ],
  entryComponents: [
    UploadDocumentDialogComponent,
    EditNotesDialogComponent
